...
import com.example.mercadolivro.controller.response.FieldErrorResponse
...
class ControllerAdvice {
    ...
    fun handleNotFoungException(ex: NotFoundException, request: WebRequest): ResponseEntity<ErrorResponse> {
